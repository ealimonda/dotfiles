...
syn keyword hConstant mf_pvp_nocalcrank mf_battleground mf_reset mf_notomb mf_nocashshop mf_gvg_noguild
...
syn keyword hConstant MAX_LEVEL MAX_STORAGE MAX_GUILD_STORAGE MAX_MASTER_STORAGE MAX_CART MAX_INVENTORY MAX_ZENY
syn keyword hConstant MAX_BG_MEMBERS MAX_CHAT_USERS MAX_REFINE
...
syn match hMapName contained display "\%(1@eom\|1@jtb\|c_tower2_\|c_tower3_\|dungeon000\|dungeon001\|gef_vilg00\)"
syn match hMapName contained display "\%(gef_vilg01\|moc_dugn01\|moc_dugn02\|moc_intr00\|moc_intr01\|moc_intr02\)"
syn match hMapName contained display "\%(moc_intr04\|moc_vilg00\|moc_vilg01\|moc_vilg02\|mrc_fild01\|mrc_fild02\)"
syn match hMapName contained display "\%(mrc_fild03\|mrc_fild04\|pro_fild00\|pro_fild01\|pro_fild04\|pro_fild05\)"
syn match hMapName contained display "\%(prt_cstl00\|prt_cstl01\|prt_dugn00\|prt_dugn01\|prt_dugn02\|prt_dugn03\)"
syn match hMapName contained display "\%(prt_intr01\|prt_intr02\|prt_vilg00\|prt_vilg01\|prt_vilg02\|payold\)"
syn match hMapName contained display "\%(payold_2\|payold01\|payold02\|moc_old\|moc_old_2\|prt_are_1\|prt_are_2\)"
syn match hMapName contained display "\%(prt_are_3\|prt_are_4\|que_skin\)"
...
syn keyword hMobId RODA_FROG WOLF SPORE ZOMBIE ARCHER_SKELETON CREAMY PECOPECO MANDRAGORA ORK_WARRIOR WORM_TAIL SNAKE
syn keyword hMobId MUNAK SOLDIER_SKELETON ISIS ANACONDAQ POPORING VERIT ELDER_WILOW THARA_FROG HUNTER_FLY GHOUL
syn keyword hMobId SIDE_WINDER OSIRIS BAPHOMET GOLEM MUMMY STEEL_CHONCHON OBEAUNE MARC DOPPELGANGER PECOPECO_EGG
syn keyword hMobId THIEF_BUG_EGG PICKY PICKY_ THIEF_BUG ROCKER THIEF_BUG_ THIEF_BUG__ MUKA SMOKIE YOYO METALLER
syn keyword hMobId MISTRESS BIGFOOT NIGHTMARE PORING_ LUNATIC MEGALODON STROUF VADON CORNUTUS HYDRA SWORD_FISH KUKRE
syn keyword hMobId PIRATE_SKEL KAHO CRAB SHELLFISH SKELETON POISON_SPORE RED_PLANT BLUE_PLANT GREEN_PLANT YELLOW_PLANT
syn keyword hMobId WHITE_PLANT SHINING_PLANT BLACK_MUSHROOM RED_MUSHROOM GOLDEN_BUG ORK_HERO VOCAL TOAD MASTERING
syn keyword hMobId DRAGON_FLY VAGABOND_WOLF ECLIPSE AMBERNITE ANDRE ANGELING ANT_EGG ANUBIS ARGIOPE ARGOS BAPHOMET_
syn keyword hMobId BATHORY CARAMEL COCO DENIRO DESERT_WOLF DESERT_WOLF_B DEVIACE DEVIRUCHI DOKEBI DRAINLIAR DRAKE DROPS
syn keyword hMobId DUSTINESS EDDGA EGGYRA EVIL_DRUID FLORA FRILLDORA GHOSTRING GIEARTH GOBLIN_1 GOBLIN_2 GOBLIN_3
syn keyword hMobId GOBLIN_4 GOBLIN_5 HODE HORN HORONG JAKK JOKER KHALITZBURG KOBOLD_1 KOBOLD_2 KOBOLD_3 MAGNOLIA MANTIS
syn keyword hMobId MARDUK MARINA MARINE_SPHERE MARIONETTE MARSE MARTIN MATYR MAYA MEDUSA MINOROUS MOONLIGHT MYST
syn keyword hMobId ORC_SKELETON ORC_ZOMBIE PASANA PETIT PETIT_ PHARAOH PHEN PHREEONI PIERE PLANKTON RAFFLESIA RAYDRIC
syn keyword hMobId REQUIEM SAND_MAN SAVAGE SAVAGE_BABE SKEL_WORKER SOHEE STAINER TAROU VITATA ZENORC ZEROM WHISPER
syn keyword hMobId NINE_TAIL THIEF_MUSHROOM CHONCHON_ FABRE_ WHISPER_ WHISPER_BOSS SWITCH BON_GUN ORC_ARCHER ORC_LORD
syn keyword hMobId MIMIC WRAITH ALARM ARCLOUSE RIDEWORD SKEL_PRISONER ZOMBIE_PRISONER DARK_PRIEST PUNK ZHERLTHSH RYBIO
syn keyword hMobId PHENDARK MYSTELTAINN TIRFING EXECUTIONER ANOLIAN STING WANDER_MAN CRAMP BRILIGHT IRON_FIST HIGH_ORC
syn keyword hMobId CHOCO STEM_WORM PENOMENA KNIGHT_OF_ABYSS M_DESERT_WOLF M_SAVAGE META_FABRE META_PUPA META_CREAMY
syn keyword hMobId META_PECOPECO_EGG PROVOKE_YOYO SMOKING_ORC META_ANT_EGG META_ANDRE META_PIERE META_DENIRO META_PICKY
syn keyword hMobId META_PICKY_ MARIN SASQUATCH JAKK_XMAS GOBLINE_XMAS COOKIE_XMAS ANTONIO CRUISER MYSTCASE CHEPET
syn keyword hMobId KNIGHT_OF_WINDSTORM GARM GARGOYLE RAGGLER NERAID PEST INJUSTICE GOBLIN_ARCHER GRYPHON DARK_FRAME
syn keyword hMobId WILD_ROSE MUTANT_DRAGON WIND_GHOST MERMAN COOKIE ASTER CARAT BLOODY_KNIGHT CLOCK C_TOWER_MANAGER
syn keyword hMobId ALLIGATOR DARK_LORD ORC_LADY MEGALITH ALICE RAYDRIC_ARCHER GREATEST_GENERAL STALACTIC_GOLEM
syn keyword hMobId TRI_JOINT STEAM_GOBLIN SAGEWORM KOBOLD_ARCHER CHIMERA ARCHER_GUARDIAN KNIGHT_GUARDIAN
syn keyword hMobId SOLDIER_GUARDIAN EMPELIUM MAYA_PUPLE SKELETON_GENERAL WRAITH_DEAD MINI_DEMON CREMY_FEAR
syn keyword hMobId KILLER_MANTIS OWL_BARON KOBOLD_LEADER ANCIENT_MUMMY ZOMBIE_MASTER GOBLIN_LEADER CATERPILLAR AM_MUT
syn keyword hMobId DARK_ILLUSION GIANT_HONET GIANT_SPIDER ANCIENT_WORM LEIB_OLMAI CAT_O_NINE_TAIL PANZER_GOBLIN
syn keyword hMobId GAJOMART MAJORUROS GULLINBURSTI TURTLE_GENERAL MOBSTER PERMETER ASSULTER SOLIDER FUR_SEAL HEATER
syn keyword hMobId FREEZER OWL_DUKE DRAGON_TAIL SPRING_RABBIT SEE_OTTER TREASURE_BOX1 TREASURE_BOX2 TREASURE_BOX3
syn keyword hMobId TREASURE_BOX4 TREASURE_BOX5 TREASURE_BOX6 TREASURE_BOX7 TREASURE_BOX8 TREASURE_BOX9 TREASURE_BOX10
syn keyword hMobId TREASURE_BOX11 TREASURE_BOX12 TREASURE_BOX13 TREASURE_BOX14 TREASURE_BOX15 TREASURE_BOX16
syn keyword hMobId TREASURE_BOX17 TREASURE_BOX18 TREASURE_BOX19 TREASURE_BOX20 TREASURE_BOX21 TREASURE_BOX22
syn keyword hMobId TREASURE_BOX23 TREASURE_BOX24 TREASURE_BOX25 TREASURE_BOX26 TREASURE_BOX27 TREASURE_BOX28
syn keyword hMobId TREASURE_BOX29 TREASURE_BOX30 TREASURE_BOX31 TREASURE_BOX32 TREASURE_BOX33 TREASURE_BOX34
syn keyword hMobId TREASURE_BOX35 TREASURE_BOX36 TREASURE_BOX37 TREASURE_BOX38 TREASURE_BOX39 TREASURE_BOX40 G_ASSULTER
syn keyword hMobId APOCALIPS LAVA_GOLEM BLAZZER GEOGRAPHER GRAND_PECO SUCCUBUS FAKE_ANGEL GOAT LORD_OF_DEATH INCUBUS
syn keyword hMobId THE_PAPER HARPY ELDER DEMON_PUNGUS NIGHTMARE_TERROR DRILLER GRIZZLY DIABOLIC EXPLOSION DELETER
syn keyword hMobId DELETER_ SLEEPER GIG ARCHANGELING DRACULA VIOLY GALAPAGO ROTAR_ZAIRO G_MUMMY G_ZOMBIE CRYSTAL_1
syn keyword hMobId CRYSTAL_2 CRYSTAL_3 CRYSTAL_4 EVENT_BAPHO KARAKASA SHINOBI POISON_TOAD ANTIQUE_FIRELOCK
syn keyword hMobId MIYABI_NINGYO TENGU KAPHA BLOOD_BUTTERFLY RICE_CAKE_BOY LIVE_PEACH_TREE EVIL_CLOUD_HERMIT
syn keyword hMobId WILD_GINSENG BABY_LEOPARD WICKED_NYMPH ZIPPER_BEAR DARK_SNAKE_LORD G_FARMILIAR G_ARCHER_SKELETON
syn keyword hMobId G_ISIS G_HUNTER_FLY G_GHOUL G_SIDE_WINDER G_OBEAUNE G_MARC G_NIGHTMARE G_POISON_SPORE G_ARGIOPE
syn keyword hMobId G_ARGOS G_BAPHOMET_ G_DESERT_WOLF G_DEVIRUCHI G_DRAINLIAR G_EVIL_DRUID G_JAKK G_JOKER G_KHALITZBURG
syn keyword hMobId G_HIGH_ORC G_STEM_WORM G_PENOMENA G_SASQUATCH G_CRUISER G_CHEPET G_RAGGLER G_INJUSTICE G_GRYPHON
syn keyword hMobId G_DARK_FRAME G_MUTANT_DRAGON G_WIND_GHOST G_MERMAN G_ORC_LADY G_RAYDRIC_ARCHER G_TRI_JOINT
syn keyword hMobId G_KOBOLD_ARCHER G_CHIMERA G_MANTIS G_MARDUK G_MARIONETTE G_MATYR G_MINOROUS G_ORC_SKELETON
syn keyword hMobId G_ORC_ZOMBIE G_PASANA G_PETIT G_PETIT_ G_RAYDRIC G_REQUIEM G_SKEL_WORKER G_ZEROM G_NINE_TAIL
syn keyword hMobId G_BON_GUN G_ORC_ARCHER G_MIMIC G_WRAITH G_ALARM G_ARCLOUSE G_RIDEWORD G_SKEL_PRISONER
syn keyword hMobId G_ZOMBIE_PRISONER G_PUNK G_ZHERLTHSH G_RYBIO G_PHENDARK G_MYSTELTAINN G_TIRFING G_EXECUTIONER
syn keyword hMobId G_ANOLIAN G_STING G_WANDER_MAN G_DOKEBI INCANTATION_SAMURAI DRYAD KIND_OF_BEETLE STONE_SHOOTER
syn keyword hMobId WOODEN_GOLEM WOOTAN_SHOOTER WOOTAN_FIGHTER PARASITE PORING_V GIBBET DULLAHAN LOLI_RURI DISGUISE
syn keyword hMobId BLOODY_MURDERER QUVE LUDE HYLOZOIST AMON_RA HYEGUN CIVIL_SERVANT DANCING_DRAGON GARM_BABY
...
syn keyword hItemId Buff_Gift_Set Integer_Time Minstrel_Hat_1stmonth Captain_Hat_1stmonth Baseball_Cap_I_1stmonth
syn keyword hItemId Infinitus_White_Potion Infinitus_Blue_Potion
...
syn keyword hCommand sprintf sscanf strpos replacestr countstr setnpcdisplay compare getiteminfo setiteminfo
syn keyword hCommand getequipcardid sqrt pow distance min max md5 petstat callshop npcshopitem npcshopadditem
...
syn keyword hCommand makerune hascashmount setcashmount checkre getargcount getcharip is_function freeloop
...
syn keyword hCommand purchaseok shopcount channelmes masteropenstorage renamechar ascii expmission globalexpmission
syn keyword hCommand mapswarmmission dispbottomcolor loginmessage getmapdescription kickcharacter jailcharacter
syn keyword hCommand unjailcharacter isguest setrates sessiontime
syn keyword hKeyword end close close2 next return callfunc callsub
syn keyword hDeprecated menu goto set isday
