...
Irssi::settings_add_str($IRSSI{'name'}, 'growl_net_client', '10.0.0.20');
...
$growl = Net::GrowlClient->init(
	...
	'CLIENT_PASSWORD'		=> $GrowlPass,
	'CLIENT_PEER_HOST'		=> $GrowlHost,
	'CLIENT_APPLICATION_NAME'	=> $AppName,
	'CLIENT_NOTIFICATION_LIST'	=> ['Private Message', 'Hilight', 'Join', 'Part'], #The default is the first.
#	$GrowlIcon,
) or die "$!\n";
